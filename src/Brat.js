...
import 'brat-frontend-editor/dist/brat-frontend-editor'; // Import the BratFrontendEditor library
...
class ComponentX extends React.Component {
    ...
    componentDidMount() {
        // Ensure the BratFrontendEditor is available globally
        if (window.BratFrontendEditor) {
            // Get the DOM element where BratFrontendEditor will be rendered
            const elem = document.getElementById("test");

            // Example collData and docData
            const collData = {
                "messages": [],
                "items": [],
                "ui_names": {
            ...
            // Create an instance of BratFrontendEditor
            const brat = new window.BratFrontendEditor(elem, collData, docData);
        }
    }
